...
def get_answer(example, features, all_results, n_best_size,
                max_answer_length, do_lower_case, n):
    ...
    answer = {"answer" : [nbest[i].text for i in range(n)],
               "start" : [nbest[i].start_index  for i in range(n)],
               "end" : [nbest[i].end_index for i in range(n)],
               "confidence" : [probs[i] for i in range(n)],
